...
* @{
*/
#define PRODUCT_KEY "a0343d3864ca4c5eabc899485a3ad424"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "bab2453037d14e089e2c6ef197bb3150"
...
* @{
*/
#define Relay_On_BYTEOFFSET                    0
#define Relay_On_BITOFFSET                     0
#define Relay_On_LEN                           1
#define Relay_Off_BYTEOFFSET                    0
#define Relay_Off_BITOFFSET                     1
#define Relay_Off_LEN                           1
#define KEY_UP_BYTEOFFSET                    0
#define KEY_UP_BITOFFSET                     2
#define KEY_UP_LEN                           1
#define Temp_alarm_BYTEOFFSET                    9
...
typedef struct {
  uint8_t flagRelay_On:1;
  uint8_t flagRelay_Off:1;
  uint8_t flagKEY_UP:1;
  uint8_t flagTIMER:1;
} attrFlags_t;
